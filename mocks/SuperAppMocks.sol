...
import {ISuperfluid, ISuperToken, ISuperApp, ISuperAgreement, SuperAppDefinitions} from "../contracts/superfluid/Superfluid.sol";
...
contract SuperAppMockReturningEmptyCtx {
    ...
    function beforeAgreementCreated(
        ...
        bytes calldata, /*agreementData*/
        bytes calldata /*ctx*/
    ) external pure // solhint-disable-next-line no-empty-blocks
    {
