...
contract UtilsTester {
    ...
    function doInt96SafeMathMul(int96 a, int96 b)
        external
        pure
        returns (int96 c)
    {
    ...
    function doInt96SafeMathAdd(int96 a, int96 b)
        external
        pure
        returns (int96 c)
    {
    ...
    function doInt96SafeMathSub(int96 a, int96 b)
        external
        pure
        returns (int96 c)
    {
    ...
    function doInt96SafeMathDiv(int96 a, int96 b)
        external
        pure
        returns (int96 c)
    {
    ...
    function doUInt128SafeMathAdd(uint128 a, uint128 b)
        external
        pure
        returns (uint128 c)
    {
    ...
    function doInt128SafeMathSub(uint128 a, uint128 b)
        external
        pure
        returns (uint128 c)
    {
