...
import {Superfluid, ISuperApp} from "../contracts/superfluid/Superfluid.sol";
...
contract SuperfluidUpgradabilityTester is Superfluid {
    ...
    function validateContextStructLayout() external pure {
        ...
        // context.appAllowanceGranted
        {
            ...
            require(
                context.appAllowanceGranted == 42,
                "appAllowanceGranted changed location"
            );
        }
        // context.appAllowanceGranted
        {
            ...
            require(
                context.appAllowanceWanted == 42,
                "appAllowanceWanted changed location"
            );
        }
        // context.appAllowanceGranted
        {
            ...
            require(
                context.appAllowanceUsed == 42,
                "appAllowanceUsed changed location"
            );
        }
        // context.appAllowanceGranted
        {
        ...
        // context.appAllowanceToken
        {
            ...
            require(
                address(context.appAllowanceToken) == address(42),
                "appAllowanceToken changed location"
            );
        }
    }
}
